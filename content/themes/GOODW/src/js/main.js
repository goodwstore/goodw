...
$(document).ready(function() {
	...
	/* $(".shop").click(function(e) {
		...
		$(".details-list li.active").removeClass("active");
		$(".details-list li").eq(activeBikeSlider).addClass("active");
		$("#shopnow .details-wrapper").mCustomScrollbar();
		//$(".detials-section").addClass("active");
		$("#shopnow").addClass("active");
		canScroll = false;
	}); */
	...
	$(".appoint-request").click(function(e) {
		e.preventDefault();
		$(".appoint-wrapper").mCustomScrollbar();
		$(".appoint").addClass("active");
		canScroll = false;
	});

	// Appoint header close button click
	$(".appoint-header a").click(function(e) {
		e.preventDefault();
